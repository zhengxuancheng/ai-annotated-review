...
| Widget renders and supports the golden review flow | `apps/chatgpt-app/web/src/main.tsx` | `smoke:ui` adds three annotations, confirms two, builds a pack, verifies confirmed-only content, and opens the confirmation modal. |
