...
- Privacy policy URL: `https://ai-annotated-review.liujinxingde2008.workers.dev/privacy`
...
Privacy note: the URL above serves the current public policy text for the production candidate.
...
- `npm run smoke:remote`: passed against the production Cloudflare Worker endpoint at `2026-05-18T05:21:25.961Z`.
...
3. Confirm the privacy policy URL and public support contact.
